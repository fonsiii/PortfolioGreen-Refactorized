...
// Seleccionamos el checkbox y la lista de navegación
const menuIcon = document.getElementById('menu-icon'); 
const navbar = document.querySelector('.nav__list');

// Agregamos el evento de click en el icono de menú
menuIcon.addEventListener('click', () => {
    navbar.classList.toggle('active');
    menuIcon.classList.toggle('bx-x'); // Cambia el icono cuando se abre/cierra el menú
});
